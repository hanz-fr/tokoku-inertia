...
function StatusSectionFailed({ info }) {
    return (
        <StatusSection
            ...
            title="Failed"
            message="Oops, there's something wrong when we try to process your payment (╯‵□′)╯︵┻━┻"
        ></StatusSection>
    );
}
...
function StatusSectionSuccess({ info }) {
    return (
        <StatusSection
            ...
            title="Success"
            message="Product have been paid"
        ></StatusSection>
    );
}
...
function StatusSectionPending({ info }) {
    ...
    return (
        <StatusSection
            ...
            title="Pending"
            message="Product haven't been paid"
        >
    ...
    return (
        <CatalogLayout>
            <div className="w-full flex justify-center">
                <div className="max-w-[300px] p-4 bg-white shadow-sm rounded-xl">
                    {status == "pending" ? (

            ...
            <div class="p-4 lg:p-6 w-full">
                <nav class="flex items-center space-x-2 text-sm mb-6">
                    <a
                        ...
                        class="flex items-center text-gray-700 hover:text-blue-500 hover:cursor-pointer fill-current"
                    >
                        <svg
                            width="24"
                            height="24"
                    ...
                    <a
                        ...
                        class="flex items-center text-gray-700 hover:text-blue-500 hover:cursor-pointer"
                    >
                        Transactions
                    </a>
                    <svg
                ...
                >
                    <div class="space-y-6">
                        <div class="card bg-white p-6 rounded-lg shadow transition-all duration-200 flex flex-col items-center space-y-4">
                        ...
                        <div class="card text-red-500 bg-white p-6 rounded-lg shadow transition-all duration-200 space-y-4">
                            <div class="space-y-2">
                                <div class="flex items-center justify-between text-sm">
                                    <span>Expires in:</span>
                                    <span id="timer" class="font-medium">
                                        05:00
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="card bg-white p-6 rounded-lg shadow transition-all duration-200 space-y-4">

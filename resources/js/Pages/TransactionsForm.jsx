        ...
        <DashboardLayout>
            ...
            <div className="p-4 lg:p-6 w-full">
                ...
                <nav className="flex items-center space-x-2 text-sm mb-6">
                    ...
                    <ChevronIcon />
                    <Link href="/transactions" className="text-gray-700 hover:text-blue-500">Transactions</Link>
                    <ChevronIcon />
                    <span className="text-gray-700">Create Invoice</span>
                </nav>

                <div className="mb-6">
                    <h1 className="text-3xl font-bold text-gray-700 mb-2">Create Invoice</h1>
                    <p className="text-gray-600">Create an invoice to purchase an item.</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-white p-6 rounded-lg shadow space-y-4">
                            <div className="flex items-center gap-4">
                                <h2 className="text-lg font-semibold text-gray-700 flex-1">Items</h2>
                                <button
                                    type="button"
                                    onClick={addItem}
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                {items.length === 0 && (
                                    <p className="text-sm text-gray-400 text-center py-4">No items yet. Click "Add Item" to start.</p>
                                )}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center justify-between font-semibold pt-4 border-t border-gray-100 mt-2">
                                    ...
                                    <span className="text-xl text-blue-500">{formatRupiah(total)}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow space-y-4">
                            <div>
                                <label htmlFor="method" className="block text-sm font-medium text-gray-700 mb-2">Payment Method *</label>
                                <select
                                    id="method"
                                    value={paymentMethod}
            ...
            {cancelOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white rounded-lg shadow-xl w-full max-w-md p-6 text-center space-y-4">
                        <h3 className="text-lg font-semibold text-gray-800">Discard Invoice?</h3>

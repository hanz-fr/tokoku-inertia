...
import { AddIcon, CatalogueIcon, CircleAddIcon } from '../Components/Icons';
  ...
  return (
    <DashboardLayout>
        ...
        <nav className="flex items-center space-x-2 text-sm mb-6">
            <a onclick="parent.postMessage({ 'type': 'dashboard' }, '*')" className="flex items-center text-gray-700 hover:text-blue-500 fill-current">
            ...
            <a href="" className="flex items-center text-gray-700 hover:text-blue-500">Products</a>
        </nav>

        <div className="bg-white rounded-lg p-4 md:p-6 mb-6 flex flex-col md:flex-row md:items-center gap-4">
            <h1 className="text-xl md:text-3xl font-bold text-gray-800 flex-1">Products</h1>
        ...
        <div className="bg-white rounded-lg p-4 md:p-6">
            <div className="mb-6 flex items-center gap-4">
                <div className="relative flex-1">
                    <svg className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 fill-current" width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <input type="text" placeholder="Search products..." className="w-1/2 md:w-1/4 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 bg-white" />
                </div>
                <button className="flex items-center justify-center bg-white border border-gray-300 p-2 rounded-lg hover:bg-gray-50">
                    <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-gray-600">
                ...
                <table className="w-full">
                    <thead>
                        <tr className="border-b-2 border-gray-300">
                            <th className="text-left py-4 px-2 font-semibold text-gray-700">Id</th>
                            <th className="text-left py-4 px-2 font-semibold text-gray-700">Name</th>
                            <th className="text-left py-4 px-2 font-semibold text-gray-700">Description</th>
                            <th className="text-left py-4 px-2 font-semibold text-gray-700">Price</th>
                            <th className="text-left py-4 px-2 font-semibold text-gray-700">Stock</th>
                    ...
                    <tbody>
                        <tr className="border-b border-gray-200 hover:bg-white transition-colors">
                            <td className="py-4 px-2 text-gray-700">P001</td>
                            <td className="py-4 px-2 text-gray-700">
                                <p className="font-medium">Keychain Demon Slayer</p>
                            </td>
                            <td className="py-4 px-2 text-gray-600 text-sm">Basic keychain KHY</td>
                            <td className="py-4 px-2 text-gray-700 font-medium">Rp5.000</td>
                            <td className="py-4 px-2 text-gray-600 text-sm">51</td>
                            <td className="py-4 px-2">
                                <a onclick="parent.postMessage({ 'type': 'page', 'to': 'products-form' }, '*')" className="text-blue-500 hover:text-blue-700 font-medium hover:cursor-pointer">View</a>
                            </td>
                        </tr>
                        <tr className="border-b border-gray-200 hover:bg-white transition-colors">
                            <td className="py-4 px-2 text-gray-700">P002</td>
                            <td className="py-4 px-2 text-gray-700">
                                <p className="font-medium">Sticker Jujutsu Kaisen Gojo Sa...</p>
                            </td>
                            <td className="py-4 px-2 text-gray-600 text-sm">4x12 stiker gojo satoru</td>
                            <td className="py-4 px-2 text-gray-700 font-medium">Rp10.000</td>
                            <td className="py-4 px-2 text-gray-600 text-sm">23</td>
                            <td className="py-4 px-2">
                                <a onclick="parent.postMessage({ 'type': 'page', 'to': 'products-form' }, '*')" className="text-blue-500 hover:text-blue-700 font-medium hover:cursor-pointer">View</a>
                            </td>
                        </tr>
                        <tr className="border-b border-gray-200 hover:bg-white transition-colors">
                            <td className="py-4 px-2 text-gray-700">P003</td>
                            <td className="py-4 px-2 text-gray-700">
                                <p className="font-medium">Poster Asa Mitaka</p>
                            </td>
                            <td className="py-4 px-2 text-gray-600 text-sm">asa mitaka chensou man ukuran 400x300mm be...</td>
                            <td className="py-4 px-2 text-gray-700 font-medium">Rp50.000</td>
                            <td className="py-4 px-2 text-gray-600 text-sm">27</td>
                            <td className="py-4 px-2">
                                <a onclick="parent.postMessage({ 'type': 'page', 'to': 'products-form' }, '*')" className="text-blue-500 hover:text-blue-700 font-medium hover:cursor-pointer">View</a>
                            </td>
                        </tr>
                        <tr className="border-b border-gray-200 hover:bg-white transition-colors">
                            <td className="py-4 px-2 text-gray-700">P004</td>
                            <td className="py-4 px-2 text-gray-700">
                                <p className="font-medium">Dakimakura Yor Forger</p>
                            </td>
                            <td className="py-4 px-2 text-gray-600 text-sm">high quality dakimakura dacron filled high resolu...</td>
                            <td className="py-4 px-2 text-gray-700 font-medium">Rp250.000</td>
                            <td className="py-4 px-2 text-gray-600 text-sm">40</td>
                            <td className="py-4 px-2">
                                <a onclick="parent.postMessage({ 'type': 'page', 'to': 'products-form' }, '*')" className="text-blue-500 hover:text-blue-700 font-medium hover:cursor-pointer">View</a>
                            </td>
                        </tr>
                        <tr className="border-b border-gray-200 hover:bg-white transition-colors">
                            <td className="py-4 px-2 text-gray-700">P005</td>
                            <td className="py-4 px-2 text-gray-700">
                                <p className="font-medium">Pin anime yotsuba series</p>
                            </td>
                            <td className="py-4 px-2 text-gray-600 text-sm">badge 30x30 yotsuba</td>
                            <td className="py-4 px-2 text-gray-700 font-medium">Rp5.000</td>
                            <td className="py-4 px-2 text-gray-600 text-sm">12</td>
                            <td className="py-4 px-2">
                                <a onclick="parent.postMessage({ 'type': 'page', 'to': 'products-form' }, '*')" className="text-blue-500 hover:text-blue-700 font-medium hover:cursor-pointer">View</a>
                            </td>
                        </tr>
            ...
            <div className="flex items-center justify-center gap-2 mt-8">
                ...
                <button className="px-3 py-1 rounded-lg font-medium text-gray-700 hover:bg-gray-200 transition-colors">1</button>
                <button className="px-3 py-1 rounded-lg font-medium text-gray-700 hover:bg-gray-200 transition-colors">2</button>
                <button className="px-3 py-1 rounded-lg font-medium text-gray-700 hover:bg-gray-200 transition-colors">3</button>
                <button className="p-2 hover:bg-gray-200 rounded-lg transition-colors">
                    <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-gray-600">
